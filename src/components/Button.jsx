...
const Button = ({ name, link, color, icon }) => {
  ...
  return (
    ...
    >
      <button
        type="button"
        className={`flex items-center cursor-none justify-end ${selectedColorClass} ${selectedBorderClass} ${selectedGlowClass} rounded-xl font-inter px-4 py-2 shadow-md transition-all duration-300 hover:scale-105 ${!isLinkProvided && 'hidden'}`}
