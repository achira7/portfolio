        ...
        <div className="flex flex-col md:pt-3 items-center justify-center">
          <div className="flex justify-center flex-col  items-center mx-10 ">
            ...
            <div className=" justify-center items-center md:mx-36 p-8 mb-5">
              <p className="flex text-center md:text-center text-base  text-color-secondary md:leading-9 font-inter md:text-xl leading-[1.75] pb-8">
              ...
              <p className="flex text-center md:text-center text-base md:leading-9 text-color-secondary font-inter md:text-xl leading-[1.75] pb-8">
                ...
                reliability. I find great satisfaction in testing and validating
              ...
              <p className="flex text-center md:text-center text-base md:leading-9 text-color-secondary font-inter md:text-xl leading-[1.75] pb-8">
                ...
                the ever-evolving tech landscape. Beyond web development, I
              ...
              <p className="flex flex-auto text-center md:text-center text-base md:leading-9 text-color-secondary font-inter md:text-xl leading-[1.75]">
                ...
                resonate with users. This foundation naturally leads me to delve
