      ...
      <div className="flex flex-col m-5 w-full max-w-screen-2xl mx-auto space-y-10 mb-36">
        ...
        <div className="flex flex-row items-center space-x-10 mx-10">
          ...
          <p className="text-xl flex-1 text-color-secondary font-inter">
            ...
            adipiscing elit. Fusce interdum varius purus, vitae pharetra arcu
            auctor sit amet.Contrary to popular belief, Lorem Ipsum is not
            ...
            dolor sit amet..", comes from a line in section 1.10.32. Contrary to
